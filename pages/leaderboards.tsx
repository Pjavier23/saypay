  ...
  return (
    <div style={{ background: '#0a0a0a', color: '#fff', minHeight: '100vh' }}>
      ...
      <header style={{
        ...
        <div style={{ maxWidth: '80rem', margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: '1rem' }}>
            ...
            <span style={{ color: '#a855f7', fontWeight: '600' }}>Leaderboards</span>
          </div>
        </div>
      </header>
      ...
      <section style={{
        ...
        background: 'linear-gradient(180deg, rgba(168, 85, 247, 0.15) 0%, rgba(236, 72, 153, 0.1) 100%)',
        borderBottom: '1px solid rgba(255, 255, 255, 0.1)',
      }}>
            ...
            {[
              ...
              <button
                ...
                style={{
                  ...
                  border: 'none',
                  color: activeTab === tab.id ? '#a855f7' : '#999',
                  padding: '1rem 0',
              ...
              <div style={{ display: 'flex', gap: '1rem', marginBottom: '2rem' }}>
                {['thisWeek', 'allTime'].map(range => (
                  <button
                    ...
                    style={{
                      background: timeRange === range ? '#a855f7' : 'rgba(255, 255, 255, 0.05)',
                      color: '#fff',
                ...
                {mockLeaderboardData.reviewers[timeRange as 'thisWeek' | 'allTime'].map((reviewer, idx) => (
                  ...
                  >
                    ...
                    <div style={{
                      ...
                      width: '60px',
                      textAlign: 'center',
                      color: idx === 0 ? '#f59e0b' : idx === 1 ? '#a855f7' : '#999',
                    }}>
                      ...
                      {reviewer.userId ? (
                        <Link href={`/profile/${reviewer.userId}`} style={{ textDecoration: 'none', color: '#fff' }}>
                          <div style={{ cursor: 'pointer' }}>
                            <h3 style={{ fontWeight: '700', fontSize: '1.125rem', marginBottom: '0.25rem', color: '#a855f7' }}>
                              {reviewer.name}
                            </h3>
                    ...
                    <div style={{ display: 'flex', gap: '2rem', alignItems: 'center', textAlign: 'right' }}>
                      <div>
                        <div style={{ fontSize: '1.5rem', fontWeight: '900', color: '#ec4899' }}>{reviewer.upvotes}</div>
                ...
                >
                  <div style={{ display: 'flex', gap: '1.5rem', marginBottom: '1rem' }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '0.5rem' }}>
                        {review.userId ? (
                          <Link href={`/profile/${review.userId}`} style={{ textDecoration: 'none', color: '#fff' }}>
                            <h3 style={{ fontWeight: '700', fontSize: '1.125rem', color: '#a855f7', cursor: 'pointer' }}>
                              {review.author}
                            </h3>
                          </Link>
                        ) : (
                        ...
                        <span style={{ background: '#a855f7', padding: '0.25rem 0.75rem', borderRadius: '9999px', fontSize: '0.75rem', fontWeight: '600' }}>
                          Trust {review.trustScore}%
                        </span>
                      </div>
                      <p style={{ color: '#999', fontSize: '0.875rem', marginBottom: '1rem' }}>
                        Reviewed <span style={{ color: '#ec4899', fontWeight: '600' }}>{review.place}</span> {review.date}
                      </p>
                    ...
                    <div style={{ textAlign: 'right', minWidth: '80px' }}>
                      <div style={{ fontSize: '1.5rem', fontWeight: '900', color: '#f59e0b', marginBottom: '0.5rem' }}>
                        🔥 #{idx + 1}
                      </div>
            ...
            <div style={{
              ...
              {mockLeaderboardData.badges.map((badge, idx) => (
                ...
                >
                  ...
                  <div style={{ padding: '0.75rem', background: 'rgba(168, 85, 247, 0.1)', borderRadius: '0.5rem', color: '#a855f7', fontWeight: '600', fontSize: '0.875rem' }}>
      ...
      <section style={{
        padding: '4rem 2rem',
        background: 'linear-gradient(180deg, rgba(168, 85, 247, 0.1) 0%, rgba(10, 10, 10, 0) 100%)',
