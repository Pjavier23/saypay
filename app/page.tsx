  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a] text-white overflow-x-hidden">
      ...
      <nav className="fixed top-0 w-full z-50 glass px-6 py-4 flex justify-between items-center">
        <span className="text-xl font-bold gradient-text">SayPay</span>
            ...
            {!submitted ? (
              <>
                ...
                <button
                  ...
                  className="bg-purple-600 hover:bg-purple-700 text-white px-8 py-3 rounded-full font-semibold transition glow"
                >
                  Get Early Access
                </button>
              </>
            ) : (
              <div className="glass px-8 py-3 rounded-full text-purple-300 font-medium">
      ...
      <section className="py-24 px-6 max-w-4xl mx-auto text-center">
        <h2 className="text-4xl md:text-5xl font-black mb-6">
          Fake reviews are <span className="gradient-text">destroying trust.</span>
        </h2>
      ...
      <section id="pricing" className="py-24 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {actions.map(a => (
              <div key={a.label} className="glass rounded-2xl p-6 hover:border-purple-500/50 transition group">
      ...
      <footer className="border-t border-white/10 py-10 px-6 text-center text-gray-600 text-sm">
        <span className="gradient-text font-bold text-lg">SayPay</span>
